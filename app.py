...
⚠️ **IMPORTANTE: LAYOUT TITOLI (GRIGIO PIÙ SCURO + PADDING 35)**
Usa ESCLUSIVAMENTE questo HTML. 
Titolo nero su sfondo GRIGIO (#eeeeee). Riga di separazione (spacer) con sfondo ROSSO.
Copia ESATTAMENTE:
...
**TITOLO TABELLA (STILE GRIGIO #eeeeee):**
⚠️ **ISTRUZIONE:** Usa lo stesso stile (Grigio #eeeeee + Riga Rossa) delle categorie.
`<br><table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#eeeeee" style="background-color: #eeeeee; padding: 35px;" align="left">
